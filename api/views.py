...
class CartAPIView(generics.CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        country_name = request.data.get('country_name', 'United Kingdom')
        ...
        if cart:
            ...
            cart.country = country_object.name if country_object else 'United Kingdom'
            ...
            cart = api_models.Cart(
                ...
                country=country_object.name if country_object else 'United Kingdom',
                cart_id=cart_id,
                total=Decimal(price) + Decimal(Decimal(price) * Decimal(tax_rate)),
            )
            cart.save()
