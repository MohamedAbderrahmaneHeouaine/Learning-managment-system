...
from .models import Category, Course, Teacher, VariantItem, Variant, Question_Answer_Message, Question_Answer, Cart, \
    CartOrderItem, CartOrder, Certificate, CompletedLesson, Note, Review, Notification, Coupon, Wishlist, Country, \
    EnrolledCourse
